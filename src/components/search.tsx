            ...
            <div className='space-x-5 hidden md:flex'>
                <div className='border-r border-r-gray-500 pr-4'>
                    <Link href='/checkout/cart' className='relative'>
                        <svg className='h-8 w-8' viewBox="0 0 24 24" fill='none' stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">  <circle cx="9" cy="21" r="1" />  <circle cx="20" cy="21" r="1" />  <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6" /></svg>
                        {
                        Object.keys(cart ?? {}).length ?
                            <span style={{ paddingTop: '.1rem', paddingBottom: '.1rem' }} className='absolute -right-2 -bottom-2 bg-blue-400 text-white px-2 rounded-full font-semibold'>
                            {Object.keys(cart ?? {}).length}
                            </span>
                            :
                            ''
                ...
                <div>
                    <Link href='/profile'>
                        <svg className='text-black h-8 w-8' fill='none' viewBox="0 0 24 24" stroke="currentColor">
