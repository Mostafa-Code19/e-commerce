  ...
  const onSubmit = async (values: FormType) => {
    try {
        ...
        if (res.status == 200) return signIn()
          ...
          return console.log('api/register !200', res)
        }
      ...
      if (errorMessage.includes('Unique')) {
        ...
        toast.error('در ثبت نام شما خطایی رخ داد')
        return console.log('api/register err', err)
      }
    }
  };
            ...
            >
              {
                isSubmitting ? 
                  <div className='flex justify-center'>
                      <svg aria-hidden="true" className="w-6 h-6 text-gray-200 animate-spin dark:text-white fill-blue-900" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
