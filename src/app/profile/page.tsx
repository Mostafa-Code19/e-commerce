                        ...
                        <div>
                            <Link href='/profile/edit'>
                                <div className='flex justify-between items-center'>
                                    ...
                                    <svg className="h-6 w-6 my66 text-black rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <Link href='/favorite-products/'>
                                <div className='flex justify-between items-center'>
                                    <div className='flex space-x-3 items-center'>
                                        ...
                                        <span className='text-base text-black'>مورد علاقه های من</span>
                                    </div>
                                    <svg className="h-6 w-6 text-black rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7" />
                                    </svg>
                                </div>
                            </Link>
                            ...
                            <Link href='/messages/'>
                                <div className='flex justify-between items-center'>
                                    <div className='flex space-x-3 items-center'>
                                        ...
                                        <span className='text-base text-black'>پیام های من</span>
                                    </div>
                                    <svg className="h-6 w-6 text-black rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7" />
                                    </svg>
