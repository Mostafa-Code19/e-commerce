...
const Edit = () => {
    ...
    const onSubmit = async (values: FormType) => {
        const payload: FormType = Object.fromEntries(Object.entries(values).filter(([_, value]) => value !== ""));
                    ...
                    {({ isSubmitting }) => (
                        ...
                        <Form>
                            <FormikInput
                                ...
                                name='name'
                                type='string'
                                placeholder={user?.name || `لطفا نام و نام خانوادگی خود را وارد کنید...`}
                            />
                            <FormikInput
                                label='شماره همراه'
                                name='mobile_number'
                                type='string'
                                placeholder={user?.mobile_number || 'لطفا شماره همراه خود را وارد کنید...'}
                            />
                            <FormikInput
                                label='شماره ثابت'
                                name='phone_number'
                                type='string'
                                placeholder={user?.phone_number || 'لطفا شماره ثابت خود را وارد کنید...'}
                            />
                            <FormikInput
                                label='کد ملی'
                                name='melli_code'
                                type='string'
                                placeholder={user?.melli_code || 'لطفا کد ملی خود را وارد کنید...'}
                            />
                            <FormikTextarea    
                                label='آدرس محل سکونت'
                                name='address'
                                type='string'
                                placeholder={user?.address || 'لطفا آدرس محل سکونت خود را وارد کنید...'}
                            />
                            <button
                                type='submit'
