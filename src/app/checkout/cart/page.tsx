                            ...
                            <div className='space-y-3 mb-5'>
                                {
                                    ...
                                    Object.values(cart).map((item) => {
                                        return (
                                            <div key={item.id} className='flex md:px-10 items-center justify-evenly bg-white rounded-xl py-1 space-y-3'>
                                                <div className='p-2'>
                                                    <Image
                                                ...
                                                <div className='space-y-3 rtl'>
                                                    ...
                                                    <div className='-space-y-1'>
                                                        ...
                                                        <span style={{ fontSize: '1.7rem' }} className='text-black font-bold toman_product ltr'>
                                                            {
                                                    ...
                                                    <div className='flex space-x-reverse space-x-5 items-center'>
                                                        ...
                                                        <div className='flex items-center space-x-reverse space-x-1'>
                                                            <span style={{ fontSize: '.8rem', color: 'black' }}>سایز :</span>
